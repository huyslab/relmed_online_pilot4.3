...
var halfLength = Math.ceil(PITtrialList.length / 2);
var firstHalf = PITtrialList.slice(0, halfLength);
var secondHalf = PITtrialList.slice(halfLength);

firstHalf = jsPsych.randomization.shuffle(firstHalf);
secondHalf = jsPsych.randomization.shuffle(secondHalf);
PITtrialList = firstHalf.concat(secondHalf);
